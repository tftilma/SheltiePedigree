...
var kennelName2="<xsl:value-of select='kennelname2'/>";
if (kennelName==".") {kennelName = "No prefix or affix";}
if (kennelName2==".") {kennelName2 = "No prefix or affix";}
...
nChildChildren="<xsl:value-of select='nchildren'/>";
w('<tr>');
w('<td>'+nr+'</td><td><a href="'+descId+'.html">'+descName+'</a></td>');
w('<td>'+gc+'</td>');
if (fatherId!="?") {w('<td><a href="'+fatherId+'.html">'+fatherName+'</a></td>');}
else {w('<td>?</td>');}
if (motherId!="?") {w('<td><a href="'+motherId+'.html">'+motherName+'</a></td>');}
else {w('<td>?</td>');}
w('<td>'+nChildChildren+'</td>');
w('</tr>');
</xsl:template>
...
<h3>Kennels</h3>
<script language="JavaScript">
w('<a href="'+kennelId+'.html">'+kennelName+'</a>');
if (kennelId2 != "null"){
w('<br/>');
w('<a href="'+ kennelId2+'.html">'+kennelName2+'</a>');}
abc();
</script>
</div>
</div>
