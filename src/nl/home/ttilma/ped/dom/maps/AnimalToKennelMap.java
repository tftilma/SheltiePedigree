...
public class AnimalToKennelMap {
	...
	public Kennel findKennelByAnimalId1(String animalId) {
		return (Kennel) animalToKennelMap.get(animalId);
	}
	
	public Kennel findKennelByAnimalId2(String animalId) {
		return (Kennel) animalToKennelMap2.get(animalId);
	}
	
	public void addAnimal(Animal animal) {
		addAnimalForKennel(animal.getId(), animal.getKennelId(), animalToKennelMap);
		
		if (animal.getKennelId2() != null) {
			addAnimalForKennel(animal.getId(), animal.getKennelId2(), animalToKennelMap2);			
		}
	}
